package com.microservice.eurekaclient.payment.controller;
...
public class PaymentController {
	...
	// String baseURL = "http://localhost:5454/";
	...
	@HystrixCommand(fallbackMethod = "getCustomerByIdFallBack", commandProperties = @HystrixProperty(name = "execution.isolation.thread.timeoutInMilliseconds", value = "3000"))
